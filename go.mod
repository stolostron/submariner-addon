...
require (
	...
	github.com/submariner-io/cloud-prepare v0.21.3-0.20260401061347-bfc1968765bb
...
// The following dependency has an API incompatibility with k8s.io/apiserver v0.32.6
