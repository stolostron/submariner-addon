	...
	for _, c := range cases {
		t.Run(c.name, func(t *testing.T) {
			...
			awsProvider := &awsProvider{
				...
				machinesetDeployer: fakeMachineSetDeployer{},
			}
...
type fakeMachineSetDeployer struct{}

func (f fakeMachineSetDeployer) Deploy(machineSet *unstructured.Unstructured) error {
	return nil
}

func (f fakeMachineSetDeployer) GetWorkerNodeImage(machineSet *unstructured.Unstructured, infraID string) (string, error) {
	return "", nil
}

func (f fakeMachineSetDeployer) Delete(machineSet *unstructured.Unstructured) error {
	return nil
}
